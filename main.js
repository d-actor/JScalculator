// ** create a 4x4 grid with another full bar/row at top for input
// ** make each grid space a button
// ** each button logs its value or operator
// ** user can input values/operators and receive result in bar
